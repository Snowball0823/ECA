...
def coord_descent(x, W, z0=None, alpha=1.0, maxiter=1000, tol=1e-6, verbose=False, **kwargs):
    ...
    for i in range(maxiter):
        ...
        positive = kwargs.get("positive_code", False)
        if positive:
            z_new = torch.clamp(z_new, min=0)
