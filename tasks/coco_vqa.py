...
# This code is based on the code written salesforce.
...
class VQA:
    ...
    def createIndex(self):
        ...
        for ann in self.dataset["annotations"]:
            # image_id here is istance_id, generate from dataset method.
    ...
    def loadRes(self, resFile, quesFile):
        ...
        assert set(annsQuesIds) == (set(
            self.getQuesIds()
        )&set(annsQuesIds)), "Results do not correspond to current VQA set. Either the results do not have predictions for all question ids in annotation file or there is atleast one question id that does not belong to the question ids in the annotation file."
        for ann in anns:
            quesId = ann["question_id"]
