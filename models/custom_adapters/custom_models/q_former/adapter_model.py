...
from ...adapter_warp_model import adapter_init
...
class QBertAdapterModel(EmbeddingAdaptersWrapperMixin, ModelWithFlexibleHeadsAdaptersMixin, BertPreTrainedModel):
    ...
    def forward(
        ...
        **kwargs
        ...
        query_embeds = (
            query_embeds.view(-1, query_embeds.size(-2), query_embeds.size(-1))
