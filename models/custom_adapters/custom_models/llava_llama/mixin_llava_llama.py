"""Adapters mixin for LLaVA LLaMA backbone (compatible with Transformers 4.28)."""
...
class LlavaLlamaAttentionMixin:
...
class LlavaLlamaDecoderLayerMixin:
    def init_adapters(self, model_config, adapters_config):
...
class LlavaLlamaModelAdapterMixin(EmbeddingAdaptersMixin, InvertibleAdaptersMixin, ModelBaseAdaptersMixin):
