...
@registry.register_model("coda_blip2_opt_cap")
class CODABlip2OPTCap(Blip2Base):
    """
    BLIP2 OPT model.
    ...
    def adapter_structure(self):
        structure = {'lora': self.lora_dict, 'adapter': self.parallel_adapters_dict, 
                                  ...
                                  'moq_num': self.moq_num, 'prompt_type': self.prompt_type,
                                  'n_tasks': self.n_tasks, 'prompt_param': list(self.prompt_param)}
        return structure
