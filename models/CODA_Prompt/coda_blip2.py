...
from .coda_Qformer import BertConfig, BertLMHeadModel
from ..ECA_Q.eva_vit import create_eva_vit_g
from ..ECA_Q.clip_vit import create_clip_vit_L
from ..ECA_Q.utils import get_abs_path
...
class Blip2Base(BaseModel):
    ...
    def init_Qformer(cls, num_query_token, vision_width, cross_attention_freq=2):
        # TODO: may change the pretrain model weight
        encoder_config = BertConfig.from_pretrained("bert-base-uncased")
        encoder_config.model_type = "coda_q_former"
